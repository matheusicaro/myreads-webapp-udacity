...
const Home = (props) =>{
  ...
  return (
      <section id="bookcase">
        <HeaderProfile style={ styleHeaderProfile }> </HeaderProfile>
        <HeaderSearch style={ styleHeaderSearch }> </HeaderSearch>
        
        <BookCase books={ booksCurrentlyReading } style={ styleCurretlyReading } ></BookCase>
        <BookCase books={ booksWantToRead } style={ styleWantToRead }></BookCase>
        <BookCase books={ booksRead } style={ styleRead }></BookCase>
